...
import { Review, ReviewService } from '../../services/reviewservice.service';
...
export class ReviewComponent implements OnInit {
  ...
  onSubmit(): void {
    ...
    //         this.error = `Failed to submit review: ${err.error?.message || err.message || 'Unknown error'}`;
    //       }
    //     });
    //   } catch (err) {
    ...
    //   }
    // } else {
    //   console.log('Form invalid or missing packageId', {
